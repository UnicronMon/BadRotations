...
---@alias SpellListSpecTableKeys "abilities" | "animas" | "artifacts" | "buffs" | "bloodLust" | "condits" | "covenants" | "debuffs" | "essences" | "glyphs" | "talents"
---@alias SpellListKeys ClassFile | "Shared"
---@alias DeathKnightSpecID 250 | 251 | 252
---@alias DemonHunterSpecID 577 | 581
---@alias DruidSpecID 102 | 103 | 104 | 105
---@alias EvokerSpecID 1467 | 1468 | 1473
---@alias HunterSpecID 253 | 254 | 255
---@alias MageSpecID 62 | 63 | 64
---@alias MonkSpecID 268 | 269 | 270
---@alias PaladinSpecID 65 | 66 | 70
---@alias PriestSpecID 256 | 257 | 258
---@alias RogueSpecID 259 | 260 | 261
---@alias ShamanSpecID 262 | 263 | 264
---@alias WarlockSpecID 265 | 266 | 267
---@alias WarriorSpecID 71 | 72 | 73
---@alias AllSpecID DeathKnightSpecID | DemonHunterSpecID | DruidSpecID | EvokerSpecID | HunterSpecID | MageSpecID | MonkSpecID | PaladinSpecID | PriestSpecID | RogueSpecID | ShamanSpecID | WarlockSpecID | WarriorSpecID

---@class SpellList
---@field [SpellListKeys] { [AllSpecID | "Shared"]: { [SpellListSpecTableKeys]: { [string]: number | { [string] : number } },  } }
br.lists.spells = {
    DEATHKNIGHT = {
        -- Blood
        [250] = {
    ...
    Shared = {
        Shared = {
            ...
            buffs     = {
                ...
                blessingOfFreedom             = 1044,
                blessingOfProtection          = 1022,
                draconicAugmentRune           = 393438,   -- DF Augment Rune
                bloodLust                     = {
                    ancientHysteria     = 90355,
                    bloodlust           = 2825,
                    drumsOfRage         = 146555,
